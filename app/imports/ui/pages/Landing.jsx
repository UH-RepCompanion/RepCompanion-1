    ...
    <Row className="text-center">
      <Col>
        ...
        <Row className="justify-content-center">
          <Button className="py-3 justify-content-center" variant="dark" id="landing-page-button" style={{ marginTop: '20px', marginBottom: '20px', width: '150px' }}> Login </Button>
        </Row>
        <Row className="justify-content-center">
          <Button className="py-3 justify-content-center" variant="dark" style={{ marginTop: '20px', marginBottom: '20px', width: '150px' }}> Register </Button>
        </Row>
      </Col>
      <LandingPageCard />
    </Row>
