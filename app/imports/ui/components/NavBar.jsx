...
const NavBar = () => {
  ...
  return (
    <Navbar bg="dark" expand="lg" className="gradient">
      <Container>
        <Image width={45} height={45} style={{ marginTop: '10px', marginBottom: '20px', marginRight: '10px', borderRadius: '50%' }} className="rounded-circle" src="../images/uh-repcompanion.png" />
