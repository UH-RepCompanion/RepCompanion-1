 ...
 */
Meteor.methods({
  'Profiles.update'({ email, firstName, lastName, bio, major, picture, socialLink1, socialLink2, socialLink3, interests, tag }) {
    Profiles.collection.update({ email }, { $set: { email, firstName, lastName, bio, major, picture, tag, interests, socialLink1, socialLink2, socialLink3 } }, { upsert: true });
