 ...
 */
Meteor.methods({
  'Profiles.update'({ email, firstName, lastName, bio, major, picture, interests, tag, instagramLink, facebookLink, spotifyLink }) {
    Profiles.collection.update({ email }, { $set: { email, firstName, lastName, bio, major, picture, tag, interests, instagramLink, facebookLink, spotifyLink } }, { upsert: true });
